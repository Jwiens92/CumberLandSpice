	...
	$aHelp = array(
		...
		*/
		...
		array(
			...
			'description' => '',
			'usage' => '[icon icon="img-1" animation="showup" title="Your title" content="Your content here..."]',
			'code' => '[icon icon="{icon}" url="{url}" target="{target}" animation="{animation}" title="{title}" content="{content}"]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
 ...
 * @return array
 */
function ts_getFontAwesomeArray($bNoIconChoice = false,$add_icons = null)
{
	$icons = array();
