...
<div id="control-panel">
	<div class="panel-container">
		...
		<div class="panel-content">
			...
			<?php $header_styles = ts_get_header_styles(); ?>
			<?php if (is_array($header_styles) && count($header_styles) > 0): ?>
				<h3><?php _e('Choose header style','framework'); ?></h3>
				<select>
					<?php foreach ($header_styles as $style): ?>
						<option <?php echo $main_menu_style == $style['value'] ? 'selected=selected' : ''; ?> value="<?php echo add_query_arg( array('switch_main_menu_style' => $style['value']) ); ?>"><?php echo $style['label'];?></a></option>
					<?php endforeach; ?>
				</select>
			<?php endif; ?>
			<hr>
