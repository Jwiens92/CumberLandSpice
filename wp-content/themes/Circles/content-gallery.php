				...
				<div class='container-t1'>
					<div class='container-t1-margin'>
						...
						switch ($featured_image_align)
						{
							case 'left':
							case 'right':
								the_resized_post_thumbnail_sidebar(array('full-aligned', 'one-sidebar-aligned', 'two-sidebars-aligned'),get_the_title());
								break;
							case 'center':
							default:
								the_resized_post_thumbnail_sidebar(array('full', 'one-sidebar', 'two-sidebars'),get_the_title());
								break;
						}
						?>
					</div>
