...
ts_add_theme_image_size('person-mid', 325, 168, true);
...
function ts_theme_scripts() {
	...
	wp_register_script( 'zozo-tabs', get_template_directory_uri().'/js/zozo.tabs.js',null,null,true);
	wp_register_script( 'main', get_template_directory_uri().'/js/main.js',array('jquery'),null,true);
    wp_register_script( 'nicescroll', get_template_directory_uri().'/js/jquery.nicescroll.js',array('jquery'),null,true);
    ...
    wp_register_script( 'shortcodes', get_template_directory_uri().'/js/shortcodes.js',array('jquery'),null,true);
    wp_register_script( 'retina', get_template_directory_uri().'/js/retina.js',null,null,true);
    wp_register_script( 'grayscale', get_template_directory_uri().'/js/grayscale.js',array('jquery'),null,true);
